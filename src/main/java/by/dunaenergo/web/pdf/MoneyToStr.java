...
public class MoneyToStr {
	 ...
	 * MoneyToStr.Currency.UAH, MoneyToStr.Language.UKR,
	 * MoneyToStr.Pennies.NUMBER); Definition for currency is placed into
	 * currlist.xml
	 *
	 * @param currency
	 ...
	 * MoneyToStr(MoneyToStr.Currency.UAH, MoneyToStr.Language.UKR,
	 * MoneyToStr.Pennies.NUMBER); String result = moneyToStr.convert(123D);
